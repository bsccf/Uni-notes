...
### Finding stress range at the crack tip
...
Hence we are left with an equation: $\Delta K &=  (\Delta \sigma )Y  \sqrt{\pi a}$ that describes the stress range experienced at the crack tip.
