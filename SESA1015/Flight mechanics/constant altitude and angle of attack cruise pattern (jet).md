...
&= \frac{\left(\frac{C_{D0}+K}{\pi A}C_L^{2}\right) \frac{1}{2} C_L^{\frac{-1}{2}} - C_L^{\frac{1}{2}} \frac{2K}{\pi A} C_L}{ \left(C_{D0} + \frac{K}{\pi A} C_L^{2}\right)^2 }\\
0 &= \left(\frac{C_{D0}+K}{\pi A}C_L^{2}\right) \frac{1}{2} C_L^{\frac{-1}{2}} - C_L^{\frac{1}{2}} \frac{2K}{\pi A} C_L\\
C_L^{\frac{1}{2}} \frac{2K}{\pi A} C_L &= \left(\frac{C_{D0}+K}{\pi A}C_L^{2}\right) \frac{1}{2} C_L^{\frac{-1}{2}}\\
C_L^{\frac{3}{2}} \frac{4K}{\pi A}  &= \left(\frac{C_{D0}+K}{\pi A}C_L^{2}\right) C_L^{\frac{-1}{2}}
\end{align*}$$